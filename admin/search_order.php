...
<div class="container">
<br><br><br><br>
<center><h1><strong>Search Orders Data</strong></h1></center>

<fieldset>

<br><br>
<center>
<form name="search_product" method="post" action="db_search_order.php" enctype="multipart/form-data">
    <table width="50%" border="1" align="center">
      <tr>
       
        <td width="85%" align="center"><input type="text" placeholder="Enter order id" name="search_order" size="50" />  <i class="fa fa-search"></i> </td>
      </tr>  
       <tr> 
