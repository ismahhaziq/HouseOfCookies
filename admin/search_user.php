...
<div class="container">
<br><br><br><br><br>
<center><h1><strong>Search Customer</strong></h1></center>
...
<form name="form1" method="post" action="db_search_user.php" enctype="multipart/form-data">
    <table width="50%" border="1" align="center">
      <tr>
        <td width="85%" align="center"><input type="text" placeholder="Enter customer name" name="search_name" size="50" /> <i class="fa fa-search"></i> </td>
      </tr>  
       <tr> 
        <td align="center"><input type="submit" name="submit" value=" Search " onclick="location.href='db_search_user.php'" />
