...
<div class="container">
<br><br><br><br>
<h1><center><strong>Update Product Data</strong></center></h1>
<?php
...
<form name="add_product" method="post" action="db_update_product.php" enctype="multipart/form-data">
    <table width="70%" border="1" align="center">
      ...
      <tr> 
        ...
        <td>
     <textarea name="description" rows="10" cols="52"><?php echo ucwords (strtolower($row['details'])); ?></textarea>
    </td>  
      </tr>
        <tr> 
        <td width="20%">QUANTITY</td>
        <td>
     <textarea name="qty" rows="1" cols="30"><?php echo ucwords (strtolower($row['qty'])); ?></textarea>
    </td>  
      </tr>
    <tr>
        <td>STATUS</td>
      ...
      <?php     
          if ($row['product_category']=='1') {
            echo "<option value='1' selected> Hari Raya </option>";
            echo "<option value='2'> Chinese New Year </option>";
            echo "<option value='2'> Christmas </option>";
            }
          else if ($row['product_category']=='2'){
            echo "<option value='1'>Hari Raya</option>";
            echo "<option value='2' selected> Chinese New Year </option>";
            echo "<option value='2'> Christmas </option>";
          }
          else echo "<option value='3' selected> Christmas </option>";
      ?>
      </select>
    </td>
      </tr>
