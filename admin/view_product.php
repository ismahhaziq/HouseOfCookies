...
<br><br>
<div class="container">
<center><h1><strong>Product Available</strong></h1></center>

  <?php
    $query = "SELECT * FROM cookies  WHERE product_status = '1' ORDER BY product_category";
...
<br>
  <br>
  <br>
 <center><h1><strong>Product Not Available</strong></h1></center>
 <?php
    $query = "SELECT * FROM cookies  WHERE product_status = '2' ORDER BY product_category";
    $result = mysqli_query($dbconn, $query) or die ("Error: " . mysqli_error($dbconn));
    $numrow = mysqli_num_rows($result);
  ?>
   <tr align="left" bgcolor="#FAAFBE">
