...
body {
  ...
  color: #ffffff;
  background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('../image/cookiesweb.png');
...
<center><h1><strong>Total Of Cookies Order</strong></h1></center>
  <?php
    $query = "SELECT SUM(quant) FROM orders_detail";
    $result = mysqli_query($dbconn, $query) or die ("Error: " . mysqli_error($dbconn));
    $numrow = mysqli_num_rows($result);
  ?>
  <tr align="left" bgcolor="">
    <td>
    <table width="50%" border="1" align="center" cellpadding="7" cellspacing="0">
    ...
    ?>
    <td>&nbsp;<?php echo ucwords (strtolower($row['SUM(quant)'])); ?></td>
    </tr>
    <?php 
       $color="2";}
     else{
