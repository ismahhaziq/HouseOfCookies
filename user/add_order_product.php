...
<h3><center><strong>Add Order</strong></center></h3>
          ...
          else
          {
            ...
            $no++;
                ...
                echo "<tr>
                      ...
                      <td><input type='submit' name='submit' id='print' value='Print'</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                        <td align='center' colspan='4'>
                            <input type='reset' name='back' id='reset' value='   Cancel Order   ' />  
                        </td>
                        </tr>
                    ";
                echo "</table>";
