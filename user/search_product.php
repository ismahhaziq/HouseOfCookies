...
<div class="container">
<br><br><br><br>
<center><h1><strong>Search Cookies</strong></h1></center>

<fieldset>

<br><br>
<center>
<form name="search_product" method="post" action="db_search_product.php" enctype="multipart/form-data">
    <table width="50%" border="1" align="center">
      <tr>
       
        <td width="85%" align="center"><input type="text" placeholder="Enter product name" name="search_name" size="50" />  <i class="fa fa-search"></i> </td>
      </tr>  
       <tr> 
        <td align="center" colspan="2"><input type="submit" name="search_product" value=" Search " onclick="location.href='db_search_product.php'" />
