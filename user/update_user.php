...
#customers tr:nth-child(even){background-color: #F9A7B0;}
...
<div class="container">
<br><br><br><br><br>
<center><h1><strong> Update Details</h1></strong></center>
...
?>
  ...
  <form name="edit_user" method="post" action="db_update_user.php" enctype="multipart/form-data">
      <table width="60%" border="1" align="center">
        ...
        <tr>
          <td width="20%">Name</td>  
          <td><input type="text" placeholder="Fawaz Hanif" name="name" size="50" value="<?php echo ucwords (strtolower($row['name'])); ?>" /><br/></td>  
        </tr> 

        <tr>
          <td width="20%">Email Address</td>  
          <td><input type="text" placeholder="Suga@gmail.com" name="email" size="50" value="<?php echo $row['email']; ?>"/></td>  
        </tr> 

        <tr>
          <td width="20%">Phone No</td>  
          <td><input type="text" placeholder="019-6632441" name="phone" size="50" value="<?php echo $row['phoneNo']; ?>"/></td>  
        </tr>

      <tr>
          <td width="20%">Address</td>  
          <td><textarea name="address" placeholder="Sg Hijau, Bangi" cols="47" rows="3"><?php echo ucwords (strtolower($row['address'])); ?></textarea></td>  
      </tr>
      ...
      <tr>
          ...
          <td><input type="password" name="password" placeholder="Password" size="50" value="<?php echo $row['password']; ?>" /></td>  
      </tr>
