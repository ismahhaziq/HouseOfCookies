...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">       
  ...
  <div class="title">
   <center><h1><strong>BISKUT RAYA</strong></h1></center>
  </div>
  <?php
    $query = "SELECT * FROM cookies  WHERE product_category = '1' ORDER BY product_id";
...
<figure class="snip">                <!-- first -->
  <h5><?php echo ucwords (strtolower($row['product_name'])); ?></h5>
  <div class="image">
